...
#import "SVW_LoginPwdInputTableViewCell.h"
#import "SVW_LoginViewModel.h"


@interface SVW_LoginPwdInputTableViewCell () <UITextFieldDelegate>
@end


@implementation SVW_LoginPwdInputTableViewCell
...
- (void)bindViewModel:(id<SVW_ViewModelProtocol>)viewModel withParams:(NSDictionary *)params {
    if ([viewModel isKindOfClass:[SVW_LoginViewModel class]]) {
        SVW_LoginViewModel *_viewModel = (SVW_LoginViewModel *)viewModel;
        @weakify(self);
        // 密码显示和切换
