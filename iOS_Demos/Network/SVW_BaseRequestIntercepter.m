//
//  SVW_BaseRequestIntercepter.m

#import "SVW_BaseRequestIntercepter.h"
#import "Aspects.h"


@implementation SVW_BaseRequestIntercepter

+ (void)load {
    [super load];

    [SVW_BaseRequestIntercepter sharedInstance];
}

+ (instancetype)sharedInstance {
    static dispatch_once_t             onceToken;
    static SVW_BaseRequestIntercepter *sharedInstance;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[SVW_BaseRequestIntercepter alloc] init];
    });
...
// hook 你所想
- (id)_requestArgumentWithInstance:(SVW_BaseRequest *)instance originReturnValue:(id)originReturnValue SVW_Deprecated("Do not use any more") {
